#Le serveur envoie à chaque client :
#   La position de la balle
#   La position de la barre adverse
#Il reçoit de chaque client :
#   La position de sa barre


#Si une deconnexion a lieu, le serveur previent le joueur restant
#qu'il a gagne par forfait

#Au debut de la partie, le serveur echange les infos sur les skins de chaque joueur,
#le background, etc.

#Lancer le serveur (rooms de deux joueurs) : server.py --tcpport 1234 --udpport 1234 --capacity 2
...
def main_loop(tcp_port, udp_port, rooms):
    ...
    print("clear : delete all rooms from the server")
